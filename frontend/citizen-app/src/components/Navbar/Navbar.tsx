  ...
  return (
    <nav className="navbar">
      ...
      <div className="nav-links">
        ...
        <Link to="/issues" className={`nav-link ${isActive("/issues") ? "active" : ""}`}>Issues</Link>
        <Link to="/report" className={`nav-link nav-link--highlight ${isActive("/report") ? "active" : ""}`}>
          <span className="plus-icon">+</span> Report Issue
        </Link>
        {userEmail && (
      ...
      {!userEmail ? (
        ...
        <div className="user-section" ref={dropdownRef}>
          ...
          >
            ...
            <svg className={`chevron ${dropdownOpen ? "rotate" : ""}`} width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
          ...
          {dropdownOpen && (
            <div className="user-dropdown">
              ...
              <Link to="/report" className="dropdown-item" onClick={() => setDropdownOpen(false)}>
